...
#   curl -fsSL ... | bash -s organizar-imports           # uma skill específica
#   curl -fsSL ... | bash -s organizar-imports outra      # várias skills
#   curl -fsSL ... | bash -s list                          # lista as disponíveis
set -euo pipefail
...
node "$TMP/repo/scripts/install.js" "$@"
